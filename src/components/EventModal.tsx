  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h4 style={{ color: '#e2e8f0', fontWeight: 'bold', marginBottom: 14 }}>
        ...
        {[
          ...
          <div key={label} style={{ marginBottom: 10 }}>
            <label style={{ color: 'rgba(255,255,255,1)', display: 'block', marginBottom: 4, fontWeight: 'bold' }}>{label}</label>
            {el}
          </div>
        ))}

        <div style={{ marginBottom: 10 }}>
          <label style={{ color: 'rgba(255,255,255,1)', display: 'block', marginBottom: 8, fontWeight: 'bold' }}>Cor</label>
